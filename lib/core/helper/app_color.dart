...
class AppColors {
  ...
  static const Color light6 = Color(0xFFFAFAFA);

  ///Dark shades
  static const Color grey = Color(0xFF636B7E);
  ...
  //Color App
  static const Color babyBlue = Color(0xFFF1F8FF);
  static const Color grey0 = Color(0xFFABB3C8);
  static const Color grey2 = Color(0xFF9D9D9D);
  static const Color grey3 = Color(0xFFCFD7EC);
  static const Color grey4 = Color(0xFFF5F5F5);
  static const Color grey5 = Color(0xFF8B93A7);
  static const Color grey6 = Color(0xFFF5F5F5);
  static const Color dividerColor = Color(0xFFE0E7FD);
  static const Color borderMenuColor = Color(0xFFE9F1FF);
  static const Color dividerColor2 = Color(0xFFE9E9E9);
  static const Color headerColor = Color(0xFFF1F8FF);
  static const Color headerMenuColor = Color(0xFFD7D7D7);
  static const Color starColor = Color(0xFFFDCC0D);
  static const Color greenColor = Color(0xFF4CA387);
  static const Color greenLineColor = Color(0xFF64B39B);
  static const Color greyLineColor = Color(0xFFE2F2ED);
